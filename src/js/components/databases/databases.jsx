...
export const Databases = React.createClass({
  contextTypes: {
  ...
  componentDidMount() {
    ...
    Connection.on('add', this.onChange);
    Database.on('add', this.onChange);
    Connection.on('remove', this.onChange);
  ...
  componentWillUnmount() {
    ...
    Connection.off('add', this.onChange);
    Database.off('add', this.onChange);
    Connection.off('remove', this.onChange);
